...
@Singleton
@Component(modules = [TopicsModule::class, TopicsAbstractModule::class, LoginModule::class, LoginAbstractModule::class,RegisterModule::class, RegisterAbstractModule::class, UtilsModule::class, PostsModuleModule::class, PostsAbstractModule::class])
